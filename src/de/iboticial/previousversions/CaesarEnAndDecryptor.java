		...
		btnEntschlsseln.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (VT.equals("")) {
					...
					JOptionPane.showMessageDialog(null, "Es wurden keine gültigen Buchstaben eingegeben!", "Fehler",
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (VT.equals("") && Verschiebungszahl.equals("")) {
					...
					JOptionPane.showMessageDialog(null,
							"Es wurden keine gültigen Buchstaben und kein gültiger Zahlenwert eingegeben!", "Fehler",
							JOptionPane.INFORMATION_MESSAGE);
					...
					if (VT.equals("")) {
						...
						if (Verschiebungszahl.equals("")) {
							...
							JOptionPane.showMessageDialog(null, "Es wurde kein gültiger Zahlenwert eingegeben!",
